<footer class="footer">
  ...
  <!--  </div>-->
  <!--  <div class="row m-0">-->
  <!--    <div class="col-md-6 col-lg lg-53">-->
  <!--      <div class="offer-left">-->
  <!--        <div class="head">-->
  <!--          <h2>Special Offers</h2>-->
  <!--          <h3>Get Your <span>Creative</span> Website</h3>-->
  <!--        </div>-->
  <!--        <div class="body">-->
  <!--          <div class="left">-->
  <!--            <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/popup/offer-img.png" alt="" />-->
  <!--          </div>-->
  <!--          <div class="right">-->
              <!-- <p class="top">Use Coupon</p> -->
  <!--            <p class="code">Grab Your Now</p>-->
  <!--            <h3>20% OFF</h3>-->
  <!--            <p class="tiny">-->
  <!--              Trust us to grow your brand's online presence and drive significant business growth.-->
  <!--            </p>-->
  <!--            <ul class="partnersUl">-->
  <!--              <li>-->
  ...
  <!--      </div>-->
  <!--    </div>-->
  <!--    <div class="col-md-6 col-lg lg-47">-->
  <!--      <x-solution-form />
  <!--    </div>-->
  <!--  </div>-->
  <!--</div>-->
  ...
  <!--    <p>This website uses cookies to ensure you get the best experience on our website. <a href="{{ route('front.privacy.policy') }}" target="_blank">Learn more</a></p>-->
