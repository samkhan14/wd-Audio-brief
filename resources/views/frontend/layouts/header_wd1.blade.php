...
<header class="header">
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-md-10 col-6 col-sm-10">
          <nav>
            <ul class="menu wd2menu">
                <li>
                    ...
                    <!--<ul class="offerCountDown">
                        <li>
                            <span class="days"></span>
                            <span class="simple">days</span>
                        </li>
                        <li>
                            <span class="hours"></span>
                            <span class="simple">hours</span>
                        </li>
                        <li>
                            <span class="min"></span>
                            <span class="simple">min</span>
                        </li>
                    </ul>-->
                </li>
                <li>
                  ...
                  <!--<div class="glow-text">-->
                  <!--    <a class="offer-btn">Activate My 70% Off Coupon</a>-->
                    <!--<button type="button" class="mt-2 mb-2 primary">Activate Your 70% Off Coupon</button>-->
                  <!--</div>-->
                </li>
            ...
            <ul class="menu mobile-toggle">
              ...
              <li>
                  <div class="link-area">
                      <a type="button" class="mt-2 mb-2 offer-btn" style="padding: 1rem;">Activate My Coupon</a>
                  </div>
