...
<section class="home-banner-area" id="wd-7-banner">
          ...
          <div class="row height-100">
            <div class="col-lg-6 col-sm-12 banner-col-wd-1 my-auto">
              <div class="banner-heading">
                ...
                <h1 class="text-white">Magento Web Development & Design Company</h1>
            ...
            <div class="col-lg-6 col-sm-12 my-auto hidemobile">
                <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/magento-webdesign/1.png" width="100%" alt="">
            </div>
          </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12 text-center">
                <div class="section-heading text-center mb-0">
                    <h2>have a <span class="color-primary">Magento</span> Project? We're Magento <span class="color-primary">Specialist</span></h2>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-12 my-auto">
                    <div class="section-heading">
                        <h2>End-To-End <span class="color-primary">Magento Development</span> Services</h2>
                    ...
                    <div class="heading-para-div">
                        <h3 class="first-heading active" onclick="toggleParagraph('first')">
                            <span class="color-primary">01</span> End-To-End Magento Development
                        </h3>
                        ...
                        <h3 class="second-heading" onclick="toggleParagraph('second')">
                            <span class="color-primary">02</span> Magento Integrations
                        </h3>
                        ...
                        <h3 class="third-heading" onclick="toggleParagraph('third')">
                            <span class="color-primary">03</span> Magento Migration & Upgrade
                        </h3>
                        ...
                        <h3 class="fourth-heading" onclick="toggleParagraph('fourth')">
                            <span class="color-primary">04</span> Magento Maintainance & Optimization
                        </h3>
                        ...
                        <h3 class="fifth-heading" onclick="toggleParagraph('fifth')">
                            <span class="color-primary">05</span> Magento Theme Development
                        </h3>
    ...
    <!-------------------------- Why Choose Magento Section ---------------------------->
    <section class="section-padding pt-0">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                    <div class="section-heading text-center">
                      <h2>Why Choose <span class="color-primary">Magento</span> For Your <span class="color-primary">eCommerce Project</span>?</h2>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            ...
            <div class="row why-choose-row">
                <div class="col-lg-7 col-sm-12">
                    <div class="text-number">
                        <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim 
                        veniam, quis nostrud.</p>
                        <p class="number">01</p>
                    </div>
                </div>
                <div class="col-lg-5 col-sm-12 my-auto text-center">
                    <h3 class="sideheadingh3">It's Scalable</h3>
                </div>
                <div class="col-lg-5 col-sm-12 my-auto text-center">
                    <h3 class="sideheadingh3">It's Customizable</h3>
                </div>
                <div class="col-lg-7 col-sm-12">
                    <div class="text-number">
                        <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim 
                ...
                <div class="col-lg-5 col-sm-12 my-auto text-center">
                    <h3 class="sideheadingh3">It's User-Friendly</h3>
                </div>
                <div class="col-lg-5 col-sm-12 my-auto text-center">
                    <h3 class="sideheadingh3">It's Secure</h3>
                </div>
                <div class="col-lg-7 col-sm-12">
                    <div class="text-number">
                        <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim 
                ...
                <div class="col-lg-5 col-sm-12 my-auto text-center">
                    <h3 class="sideheadingh3">It Supports SEO</h3>
                </div>
            </div>
        </div>
    </section>
