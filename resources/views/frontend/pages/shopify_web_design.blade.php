...
<section class="home-banner-area" id="wd-7-banner">
          ...
          <div class="row height-100">
            <div class="col-lg-6 col-sm-12 banner-col-wd-1 my-auto">
              <div class="banner-heading">
                ...
                <h1 class="text-white">Shopify Web Design & Development Company</h1>
            ...
            <div class="col-lg-6 col-sm-12 my-auto hidemobile">
                <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/custom-webdesign/1.png" width="100%" alt="">
            </div>
          </div>
    ...
    <!----------------------------------- Trusted Website Agency Section --------------------------------------->
    <section class="section-padding primary-extra-light-bg position-relative">
        <div class="bg-logos">
            <div class="owl-carousel owl-theme first-trustedwebdesignlogo">
                <div class="item">
                    <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/shopify-webdesign/shopify1.png" alt="" />
                </div>
                <div class="item">
                    <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/shopify-webdesign/shopify2.png" alt="" />
                </div>
                <div class="item">
                    <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/shopify-webdesign/shopify3.png" alt="" />
                </div>
                <div class="item">
                    <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/shopify-webdesign/shopify4.png" alt="" />
                </div>
                <div class="item">
                    <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/shopify-webdesign/shopify5.png" alt="" />
                </div>
                <div class="item">
                    <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/shopify-webdesign/shopify6.png" alt="" />
                </div>
            </div>
            <div class="owl-carousel owl-theme second-trustedwebdesignlogo">
                <div class="item">
                    <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/shopify-webdesign/shopify7.png" alt="" />
                </div>
                <div class="item">
                    <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/shopify-webdesign/shopify8.png" alt="" />
                </div>
                <div class="item">
                    <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/shopify-webdesign/shopify9.png" alt="" />
                </div>
                <div class="item">
                    <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/shopify-webdesign/shopify1.png" alt="" />
                </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12">
                <div class="section-heading text-center mb-0">
                    <h2>A Trusted <span class="color-primary">Shopify Web Design</span> Agency</h2>
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-12 my-auto">
                    <div class="section-heading">
                        <h2>Shopify <span class="color-primary">Website Design</span> Services</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis 
                        nostrud exercitation</p>
                    </div>
                    ...
                    <div class="heading-para-div">
                        <h3 class="first-heading active" onclick="toggleParagraph('first')">
                            <span class="color-primary">01</span> Custom Web Design
                        </h3>
                        ...
                        <h3 class="second-heading" onclick="toggleParagraph('second')">
                            <span class="color-primary">02</span> Custom Web Redesign
                        </h3>
                        ...
                        <h3 class="third-heading" onclick="toggleParagraph('third')">
                            <span class="color-primary">03</span> Custom Ecommerce Web Design
                        </h3>
                        ...
                        <h3 class="fourth-heading" onclick="toggleParagraph('fourth')">
                            <span class="color-primary">04</span> Professional Web Design
                        </h3>
                        ...
                        <h3 class="fifth-heading" onclick="toggleParagraph('fifth')">
                            <span class="color-primary">05</span> Custom End-To-End Development
                        </h3>
                        <p class="fifth-para hidden">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad 
                        minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                    </div>
    ...
    <!-------------------------- Reliable Shopify Website Section ---------------------------->
    <section class="section-padding position-relative" style="background-color: #ffffff;">
        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12 text-center">
                <div class="section-heading text-center mb-0">
                    <h2>Meet Our Reliable <span class="color-primary">Shopify</span> Website <span class="color-primary">Designers</span></h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis 
                    nostrud exercitation</p>
                </div>
