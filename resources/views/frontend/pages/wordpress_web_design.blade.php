...
#why-websitesec{
    background: url('https://www.websitedigitals.com/frontend/assets/images/wordpress-website/bg.png') no-repeat center center;
...
<section class="home-banner-area" id="wd-7-banner">
          ...
          <div class="row height-100">
            <div class="col-lg-6 col-sm-12 banner-col-wd-1 my-auto">
              <div class="banner-heading">
                ...
                <h1 class="text-white">WordPress Website Design Company</h1>
                <p class="text-white">Design, build, and scale with ease. Our powerful website builder and advanced business tools are designed to support your success every step of 
                the way.</p>
              </div>
            ...
            <div class="col-lg-6 col-sm-12 my-auto hidemobile">
                <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/wordpress-website/1.png" width="100%" alt="">
            </div>
          </div>
    ...
    <!-------------------------- Why Website Digital Section ---------------------------->
    <section class="section-padding dark-section" id="why-websitesec">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-12 my-auto">
                    <div class="section-heading">
                        <h2>Why Website Digitals?</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis 
                        nostrud exercitation.</p>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis 
                      ...
                      <div class="link-area">
                        <a href="#" class="primary offer-btn">Get Quote Now</a>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12">
                    <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/wordpress-website/2.png" width="100%" alt="">
                </div>
            </div>
        </div>
    </section>
