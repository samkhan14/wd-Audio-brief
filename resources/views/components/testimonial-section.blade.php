      ...
      <div class="row">
        <div class="col-12">
          <div class="section-heading text-center">
            <h2>What They Are Talking About Us</h2>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-3 col-md-4">
          <ul class="testimonials-statsUl">
            <li>
              <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/testimonials/stats/1.png" alt="" />
            ...
            <li>
              <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/testimonials/stats/2.png" alt="" />
              <div class="testimonials-stats-details">
            ...
            <li>
              <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/testimonials/stats/3.png" alt="" />
              <div class="testimonials-stats-details">
                <h3>417,789</h3>
            ...
            <li>
              <img src="{{ env('IMAGE_PATH') == '' ? asset('frontend/') : env('IMAGE_PATH') }}/assets/images/testimonials/stats/4.png" alt="" />
              <div class="testimonials-stats-details">
                <h3>634+ Projects</h3>
