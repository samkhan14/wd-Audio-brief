...
<style>
    ...
    span.free-greenBadge.price-font {
        padding: 0.25rem 0.5rem 0.125rem;
        font-size: 1.375rem;
        transform: none;
        margin-left: 0.25rem;
        background: #ff1d0f !important;
        color: #ffe000;
    }
    
    .new-offerArea > li > span.price-left.offer-left-free-red {
        background: #f00;
        color: #ffe000;
        text-transform: uppercase;
    }
    
    .new-offerArea.twin-offerArea {
        flex-direction: row;
        max-width: 39rem;
        gap: 1.5rem 3rem;
        flex-wrap: wrap;
    ...
    .new-offerArea.twin-offerArea > li {
...
<section class="horizontal-scrollAreaSection">
    <div class="position-relative white-section" id="horizontal-scrollAreaContainer">
        <div class="horizontal-scrollArea" id="horizontal-scrollArea">
            <div class="horizontal-scrollerItem first gradient-circle leftCenter-gradient">
                ...
                <div class="container position-relative">
                    ...
                    <div class="scrolled-elements-center discount_round">
                        <ul class="horizontal-points mt-3 mb-3 green-tick centered-list new-offerArea twin-offerArea">
                            <li>
                                <span class="price-left">$799</span>
                            ...
                            <li>
                                <span class="price-left offer-left-free-red">Free</span>
                                <img src="https://websitedigitals.imglab-cdn.net/assets/images/wd-5/green-tick.png?format=webp&width=28" alt="" class="tickImg"/>
                                Google Add Ons
                            </li>
                            <li>
                            ...
                            <div class="section-heading horizontal-scrollHeading headingStyle discount_round">
                                <h2>Custom <span class="color-primary">Website Design</span>
                                    <span class="subheadingStyle">
                                        Worth
                                        <span class="color-primary price-font"><sup>$</sup><span>799</span></span>
                                        <!--After Discount
                                        <span class="free-greenBadge price-font"><sup>$</sup><span>639</span></span>-->
            ...
            <div class="horizontal-scrollerItem gradient-circle leftCenter-gradient lightGray-section">
                <img class="count_section_img" src="https://websitedigitals.imglab-cdn.net/assets/images/wd-5/3.png?format=webp&width=300" alt="">
                <div class="container">
                    <div class="row rowGap2 align-items-center">
                        <div class="col-md-6">
                            <div class="horizontal-scrollImgArea">
                                <img src="https://websitedigitals.imglab-cdn.net/assets/images/wd-5/3-2.png?format=webp&width=850" alt=""/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="section-heading horizontal-scrollHeading headingStyle discount_round">
                                <h2>
                                    <span class="free-greenBadge">Free</span>
                                    <span class="color-primary">Google</span> Add Ons
                                    <span class="subheadingStyle">
                                        Worth
                                        <span class="color-primary price-font"><sup>$</sup><span>499</span></span>
                                    </span>
                                </h2>
                                <p>Ensure fast, secure, and scalable websites with responsive layouts.</p>
                                <h5>What's Includes:</h5>
            ...
            <div class="horizontal-scrollerItem gradient-circle leftCenter-gradient">
                <img class="count_section_img" src="https://websitedigitals.imglab-cdn.net/assets/images/wd-5/4.png?format=webp&width=300" alt="">
                <div class="container">
                    <div class="row rowGap2 align-items-center">
                        <div class="col-md-6">
                            <div class="horizontal-scrollImgArea">
                                <img src="https://websitedigitals.imglab-cdn.net/assets/images/wd-5/4-3.png?format=webp&width=850" alt=""/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="section-heading horizontal-scrollHeading headingStyle discount_round">
                                <h2>
                                    <span class="free-greenBadge">Free</span>
                                    <span class="color-primary">Animation</span> Add Ons
                                    <span class="subheadingStyle">
                                        Worth
                                        <span class="color-primary price-font"><sup>$</sup><span>499</span></span>
                                    </span>
            ...
            <div class="horizontal-scrollerItem gradient-circle leftCenter-gradient lightGray-section">
                <img class="count_section_img" src="https://websitedigitals.imglab-cdn.net/assets/images/wd-5/5.png?format=webp&width=300" alt="">
                <div class="container">
                    <div class="row rowGap2 align-items-center">
                        <div class="col-md-6">
                            <div class="horizontal-scrollImgArea">
                                <img src="https://websitedigitals.imglab-cdn.net/assets/images/wd-5/5-2.png?format=webp&width=850" alt=""/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="section-heading horizontal-scrollHeading headingStyle discount_round">
                                <h2>
                                    <span class="free-greenBadge">Free</span>
                                    <span class="color-primary">Branding</span> Add Ons
                                    <span class="subheadingStyle">
                                        Worth
                                        <span class="color-primary price-font"><sup>$</sup><span>499</span></span>
                                    </span>
            ...
            <div class="horizontal-scrollerItem gradient-circle leftCenter-gradient">
                <img class="count_section_img" src="https://websitedigitals.imglab-cdn.net/assets/images/wd-5/6.png?format=webp&width=300" alt="">
                <div class="container">
                    <div class="row rowGap2 align-items-center">
                        <div class="col-md-6">
                            <div class="horizontal-scrollImgArea">
                                <img src="https://websitedigitals.imglab-cdn.net/assets/images/wd-5/6-3.png?format=webp&width=850" alt=""/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="section-heading horizontal-scrollHeading headingStyle discount_round">
                                <h2>
                                    <span class="free-greenBadge">Free</span>
                                    <span class="color-primary">Social Media</span> Add Ons
                                    <span class="subheadingStyle">
                                        Worth
                                        <span class="color-primary price-font"><sup>$</sup><span>499</span></span>
                                    </span>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <ul class="original-discounted last-parallex-orig-disc original_discounted_small">
                                <li>Original Price<p class="mb-0" style="font-size: 3rem;"><sup style="1.3rem; top:-0.75rem !important; left:-0.125rem !important;">$</sup>1599</p> <img src="https://websitedigitals.imglab-cdn.net/assets/images/wd-5/vs.png?format=webp&width=50" alt="" width="100%" /></li>
                                <li>Discounted Price<span>50% OFF</span><p class="mb-0" style="font-size: 3rem;"><sup style="top:-0.75rem !important; left:-0.125rem !important;">$</sup>799</p></li>
                            </ul>
